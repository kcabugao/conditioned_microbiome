...
exp1.qy <- Exp1 %>% 
  select(Sample, Chamber, Microbe, Growth.rate.mmperday, QY_max.4, QY_max.0) %>% 
...
ggplot(data = exp1.qy, aes(x = Microbe, y = percent_loss)) + geom_boxplot() + geom_point(aes(x = Microbe), position = position_dodge(0.6)) + facet_grid(. ~ Chamber)
